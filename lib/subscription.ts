...
/** Текст про оплату на пейволе (без реквизитов — их админ присылает после заявки). */
export const PAYMENT_NOTE =
  'Нажмите «Оформить заявку» — администратор свяжется с вами и пришлёт реквизиты для оплаты. ' +
  'Доступ к ИИ откроется автоматически сразу после подтверждения оплаты.';
